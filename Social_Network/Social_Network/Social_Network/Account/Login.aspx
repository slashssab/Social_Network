<%@ Page Title="Zaloguj" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Account_Login" Async="true" %>
        ...
        <div class="col-md-8">
            <section id="loginForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="UserName"
                                CssClass="text-danger" ErrorMessage="Pole nazwy użytkownika jest wymagane." />
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <p>
                    ...
                    jeśli nie masz konta lokalnego.
                </p>
            </section>
        </div>
