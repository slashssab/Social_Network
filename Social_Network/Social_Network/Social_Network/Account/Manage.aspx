    ...
    <div class="row">
        <div class="col-md-12">
            <section id="passwordForm">
                ...
                lokalne, aby móc logować się bez zewnętrznej nazwy logowania.
                    </p>
                ...
                <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    <p>Zalogowano jako <strong><%: User.Identity.GetUserName() %></strong>.</p>
                    <div class="form-horizontal">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button runat="server" Text="Usuń" CommandName="Delete" CausesValidation="false"
                                    ToolTip='<%# "Usuń to  " + Item.LoginProvider + " logowanie z konta" %>'
